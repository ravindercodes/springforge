...
INSERT INTO users (username, email, password, provider, deleted, is_enabled, created_at, updated_at)
VALUES
    ('springforge', 'springforge@test.com', '$2a$10$kJBqZQTEFQ.VmpwSUdO7p..l0lFbKXyTzTapxof5iqu.nxGbZtErO', 'self',
